...
export const configureNpmStandardsScripts = (project: typescript.TypeScriptProject): void => {
   project.addScripts({
...
export const configureNpmBuildScripts = (project: typescript.TypeScriptProject): void => {
   project.addScripts({
...
export const configureNpmReleaseScripts = (project: typescript.TypeScriptProject): void => {
   project.addScripts({
