...
export interface SilvermineProjectOptions
   extends typescript.TypeScriptProjectOptions {
   includeTestSuite?: boolean;
   isLibrary?: boolean;
}

export const DEFAULT_PROJEN_CONFIG: SilvermineProjectOptions = {
   name: 'My Project',
...
export class SilvermineProject extends typescript.TypeScriptProject {
   public constructor(options: SilvermineProjectOptions) {
      super({
